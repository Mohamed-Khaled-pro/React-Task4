  ...
  return (
    <div className="flex justify-center items-center flex-col  mt-30 ">
      ...
      <div className="flex justify-center items-center gap-10">
        <Link
          to="installation"
          className=" hover:scale-110 hover:bg-purple-700 hover:text-white flex justify-center items-center p-3 rounded-2xl mt-10 font-bold cursor-pointer bg-white text-purple-700"
        >
          Installation
        </Link>
        <Link
